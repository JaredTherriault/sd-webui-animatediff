...
def get_interpolation_ui_controls():
    with gr.Accordion('Interpolation', open=False):
        ...
        with gr.Row():
            custom_arguments = gr.Textbox(label="Custom Arguments", type="text")
        ...
        with gr.Accordion('Advanced', open=False):
            ...
            with gr.Row(): 
                ...
                flags = gr.Number(minimum=0, maximum=3, value=0, precision=0, label="flags", type="value", info="Include additional flags to customize the optical flow calculation. The value of 0 typically means no additional flags are used.")
